"""
╔══════════════════════════════════════════════════════════════════════════╗
║         SACRSN — UNIFIED EDITION  (v80 Dimension Corrected)            ║
...
print(f"--- SACRSN v80: DIMENSION CORRECTED ---")
...
# ═══════════════════════════════════════════════════════════════════════════
# 2.  MATHEMATICAL PRIMITIVES (FIXED)
# ═══════════════════════════════════════════════════════════════════════════
...
class ComplexLayerNorm(nn.Module):
    ...
    def forward(self, z):
        ...
        # [FIX] Removed .unsqueeze(-1). Mag has same shape as z.
        # This replaces the unstable angle() calculation with a safe algebraic unit vector.
        z_unit = z / (mag + 1e-9) 
