...
print(f"--- SACRSN v47 (Fixed): PRECISION EDITION ---")
...
class SACRSN_v47(nn.Module):
    ...
    def forward_step(self, x_t, gw_state, mem_state):
        ...
        for i in range(CONFIG["max_recursion"]):
            ...
            # [FIXED CRASH] Memory State Update
            # We unsqueeze the mask to (B, 1, 1) so it broadcasts against (B, Slots, Dim)
