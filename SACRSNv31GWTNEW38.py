...
CONFIG = {
    ...
    "entropy_weight_start": 0.10, # [FIX] Added missing key
    "entropy_weight_end": 0.01,   # [FIX] Added missing key
    ...
    "depth_min": 2.0,            # [FIX] Added missing key
    "depth_max": 6.0,            # [FIX] Added missing key
    "depth_target_weight": 0.05, 
}

print(f"--- SACRSN v70: CONFIG ALIGNED EDITION ---")
...
def main():
    ...
    model = SACRSN_v70(CONFIG["vocab_size"], CONFIG["embed_dim"]).to(DEVICE)
