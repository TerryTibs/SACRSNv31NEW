"""
╔══════════════════════════════════════════════════════════════════════════╗
║         SACRSN — UNIFIED EDITION  (v75 Golden Master)                  ║
...
print(f"--- SACRSN v75: GOLDEN MASTER ---")
...
class SACRSN_Unified(nn.Module):
    ...
    def _halt(self, vq_loss, meta):
        ...
        if self.training and self.train_step < 5: # [FIX] Reduced warmup
...
def main():
    ...
    try:
        for ep in range(CONFIG["epochs"]):
            ...
            logits, stats, _, _, meta, _ = model(x)
