...
CONFIG = {
    ...
    "seq_len":           128,
    "batch_size":        32,
    "embed_dim":         128,    # Complex dimension d; each module uses d real + d imag
    "mem_slots":         32,    # Associative memory slot count
    "mem_topk":          4,     # Sparse write: only top-k slots receive update
    ...
    "halt_bias_init":    2.0,   # Learnable halt sigmoid bias
    "halt_scale_init":   8.0,  # Learnable halt scale
    ...
    "critic_weight":     0.5,   # Strength of the critic's ethical modulation
    ...
    "entropy_weight_start": 0.08,  # VQ batch entropy weight at epoch 0
    ...
    "surprise_decay":      0.95,  # EMA decay for dopamine signal
    "active_plasticity":   True, # Enable dopamine-modulated learning rate

    # ── Training ──────────────────────────────────────────────────────────
    "epochs":       2000,
    "lr":           5e-5,   # Reduced from 1e-4 → 5e-5: complex recurrent models
                             # are more sensitive to LR than standard transformers.
    "grad_clip":    0.5,
    "replay_size":  512,
