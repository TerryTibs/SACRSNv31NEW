"""
╔══════════════════════════════════════════════════════════════════════════╗
║         SACRSN — UNIFIED EDITION  (v81 Complex Autograd Fix)           ║
...
print(f"--- SACRSN v81: COMPLEX AUTOGRAD FIX ---")
...
class SACRSN_v81(nn.Module):
    ...
    def forward_step(self, x_t, gw_state, mem_state):
        ...
        for i in range(CONFIG["max_recursion"]):
            ...
            # [FIX] Split nan_to_num for Complex Autograd
            ...
            # Detach prev_angle to stop BPTT
...
def main():
    ...
    model = SACRSN_v81(CONFIG["vocab_size"], CONFIG["embed_dim"]).to(DEVICE)
